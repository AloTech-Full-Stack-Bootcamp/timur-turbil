...
module.exports = function printStats(watched, unwatched, total) {
  return `✅ ${watched} watched, ❌ ${unwatched} unwatched, 📒 ${total} total`;
}

module.exports = fancyLogSeriesReport = function (serieObj) {
  console.log(`here ${JSON.stringify(serieObj)}`)
