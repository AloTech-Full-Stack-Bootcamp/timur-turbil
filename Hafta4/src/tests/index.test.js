...
const SeriesTrackerTest = require("../index");
...
describe("SeriesTracker", () => {
  ...
  it("sets unwatched number of series (numberOfUnWatched)", () => {
    expect(mySeriesTracker.numberOfUnWatched).toEqual(6);
  });
